...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        // DREADED ITEMS
        simpleItem(ModItems.DREADED_CORE);
        simpleItem(ModItems.RAW_DREADED_PRIMORDITE);

        // VITAL ITEMS
        simpleItem(ModItems.VITAL_CORE);
        simpleItem(ModItems.RAW_VITAL_PRIMORDITE);

        // ENERGETIC ITEMS
        simpleItem(ModItems.ENERGETIC_CORE);
        simpleItem(ModItems.RAW_ENERGETIC_PRIMORDITE);

        // CEREBRAL ITEMS
        simpleItem(ModItems.CEREBRAL_CORE);
        simpleItem(ModItems.RAW_CEREBRAL_PRIMORDITE);

        // MOURNFUL ITEMS
        simpleItem(ModItems.MOURNFUL_CORE);
        simpleItem(ModItems.RAW_MOURNFUL_PRIMORDITE);
...
//        saplingItem(ModBlocks.PINE_SAPLING);
    ...
    private void trimmedArmorItem(RegistryObject<Item> itemRegistryObject) {
        final String MOD_ID = Primanomalies.MOD_ID;
    ...
    private ItemModelBuilder saplingItem(RegistryObject<Block> item) {
        ...
        return withExistingParent(item.getId().getPath(),
          ...
          new ResourceLocation(Primanomalies.MOD_ID, "block/" + item.getId().getPath()));
    }
    ...
    private ItemModelBuilder simpleItem(RegistryObject<Item> item) {
        ...
        return withExistingParent(item.getId().getPath(),
          new ResourceLocation("item/generated")).texture("layer0",
          new ResourceLocation(Primanomalies.MOD_ID, "item/" + item.getId().getPath()));
    }

    public void evenSimplerBlockItem(RegistryObject<Block> block) {
        this.withExistingParent(Primanomalies.MOD_ID + ":" + Objects.requireNonNull(ForgeRegistries.BLOCKS.getKey(block.get())).getPath(),
    ...
    public void fenceItem(RegistryObject<Block> block, RegistryObject<Block> baseBlock) {
        this.withExistingParent(Objects.requireNonNull(ForgeRegistries.BLOCKS.getKey(block.get())).getPath(), mcLoc("block/fence_inventory"))
          .texture("texture", new ResourceLocation(Primanomalies.MOD_ID, "block/"
    ...
    public void wallItem(RegistryObject<Block> block, RegistryObject<Block> baseBlock) {
        this.withExistingParent(Objects.requireNonNull(ForgeRegistries.BLOCKS.getKey(block.get())).getPath(), mcLoc("block/wall_inventory"))
          .texture("wall", new ResourceLocation(Primanomalies.MOD_ID, "block/"
            + Objects.requireNonNull(ForgeRegistries.BLOCKS.getKey(baseBlock.get())).getPath()));
    }
